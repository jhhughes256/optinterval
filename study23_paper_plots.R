...
# True vs. Pred
  ...
  levels(plotdata2$dataf) <- c("2 compartment bolus", "3 compartment bolus", "1 compartment oral", "2 compartment oral", "3 compartment oral")
