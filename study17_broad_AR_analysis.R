  ...
  for (i in 1:length(data.names)) {
    ...
    for (j in 1:length(slot.names)) {
      ...
      d.melt <- data.frame(
        ...
        data = data.names[i],
        metric = slot.names[j],
        ref = rep(d.in$true, 19),
        test = c(d.in$basic, d.in$t000, d.in$t001, d.in$t002, d.in$t010,
          d.in$t011, d.in$t012, d.in$t020, d.in$t021, d.in$t022, d.in$t100,
          d.in$t101, d.in$t102, d.in$t110, d.in$t111, d.in$t112, d.in$t120,
          d.in$t121, d.in$t122),
        type = c(rep("bas", niter), rep("000", niter), rep("001", niter),
          rep("002", niter), rep("010", niter), rep("011", niter), rep("012", niter),
          rep("020", niter), rep("021", niter), rep("022", niter), rep("100", niter),
          rep("101", niter), rep("102", niter), rep("110", niter), rep("111", niter),
          rep("112", niter), rep("120", niter), rep("121", niter), rep("122", niter)),
        ref.m1 = rep(ref.par.m[1,], 19),
        ref.m2 = rep(ref.par.m[2,], 19),
        ...
        test.nexp = rep(fit.par.nexp, 19),
        test.m1 = rep(unlist(lapply(fit.par.m, function(x) x[1])), 19),
        test.m2 = rep(unlist(lapply(fit.par.m, function(x) x[2])), 19),
        test.m3 = rep(unlist(lapply(fit.par.m, function(x) x[3])), 19),
        test.m4 = rep(unlist(lapply(fit.par.m, function(x) x[4])), 19),
        test.c1 = rep(unlist(lapply(fit.par.c, function(x) x[1])), 19),
        test.c2 = rep(unlist(lapply(fit.par.c, function(x) x[2])), 19),
        test.c3 = rep(unlist(lapply(fit.par.c, function(x) x[3])), 19),
        test.m1se = rep(unlist(lapply(fit.par.mse, function(x) x[1])), 19),
        test.m2se = rep(unlist(lapply(fit.par.mse, function(x) x[2])), 19),
        test.m3se = rep(unlist(lapply(fit.par.mse, function(x) x[3])), 19),
        test.m4se = rep(unlist(lapply(fit.par.mse, function(x) x[4])), 19),
        test.c1se = rep(unlist(lapply(fit.par.cse, function(x) x[1])), 19),
        test.c2se = rep(unlist(lapply(fit.par.cse, function(x) x[2])), 19),
        test.c3se = rep(unlist(lapply(fit.par.cse, function(x) x[3])), 19),
        time.1 = c(rep(get(data.names[i])[["tbas"]][1], niter),
          ...
          get(data.names[i])[["t022"]][1,], get(data.names[i])[["t100"]][1,],
          get(data.names[i])[["t101"]][1,], get(data.names[i])[["t102"]][1,],
          get(data.names[i])[["t110"]][1,], get(data.names[i])[["t111"]][1,],
          get(data.names[i])[["t112"]][1,], get(data.names[i])[["t120"]][1,],
          get(data.names[i])[["t121"]][1,], get(data.names[i])[["t122"]][1,]),
        time.2 = c(rep(get(data.names[i])[["tbas"]][2], niter),
          ...
          get(data.names[i])[["t022"]][2,], get(data.names[i])[["t100"]][2,],
          get(data.names[i])[["t101"]][2,], get(data.names[i])[["t102"]][2,],
          get(data.names[i])[["t110"]][2,], get(data.names[i])[["t111"]][2,],
          get(data.names[i])[["t112"]][2,], get(data.names[i])[["t120"]][2,],
          get(data.names[i])[["t121"]][2,], get(data.names[i])[["t122"]][2,]),
        time.3 = c(rep(get(data.names[i])[["tbas"]][3], niter),
          ...
          get(data.names[i])[["t022"]][3,], get(data.names[i])[["t100"]][3,],
          get(data.names[i])[["t101"]][3,], get(data.names[i])[["t102"]][3,],
          get(data.names[i])[["t110"]][3,], get(data.names[i])[["t111"]][3,],
          get(data.names[i])[["t112"]][3,], get(data.names[i])[["t120"]][3,],
          get(data.names[i])[["t121"]][3,], get(data.names[i])[["t122"]][3,]),
        time.4 = c(rep(get(data.names[i])[["tbas"]][4], niter),
          ...
          get(data.names[i])[["t022"]][4,], get(data.names[i])[["t100"]][4,],
          get(data.names[i])[["t101"]][4,], get(data.names[i])[["t102"]][4,],
          get(data.names[i])[["t110"]][4,], get(data.names[i])[["t111"]][4,],
          get(data.names[i])[["t112"]][4,], get(data.names[i])[["t120"]][4,],
          get(data.names[i])[["t121"]][4,], get(data.names[i])[["t122"]][4,]),
        time.5 = c(rep(get(data.names[i])[["tbas"]][5], niter),
          ...
          get(data.names[i])[["t022"]][5,], get(data.names[i])[["t100"]][5,],
          get(data.names[i])[["t101"]][5,], get(data.names[i])[["t102"]][5,],
          get(data.names[i])[["t110"]][5,], get(data.names[i])[["t111"]][5,],
          get(data.names[i])[["t112"]][5,], get(data.names[i])[["t120"]][5,],
          get(data.names[i])[["t121"]][5,], get(data.names[i])[["t122"]][5,]),
        time.6 = c(rep(get(data.names[i])[["tbas"]][6], niter),
          ...
          get(data.names[i])[["t022"]][6,], get(data.names[i])[["t100"]][6,],
          get(data.names[i])[["t101"]][6,], get(data.names[i])[["t102"]][6,],
          get(data.names[i])[["t110"]][6,], get(data.names[i])[["t111"]][6,],
          get(data.names[i])[["t112"]][6,], get(data.names[i])[["t120"]][6,],
          get(data.names[i])[["t121"]][6,], get(data.names[i])[["t122"]][6,]),
        time.7 = c(rep(get(data.names[i])[["tbas"]][7], niter),
          ...
          get(data.names[i])[["t022"]][7,], get(data.names[i])[["t100"]][7,],
          get(data.names[i])[["t101"]][7,], get(data.names[i])[["t102"]][7,],
          get(data.names[i])[["t110"]][7,], get(data.names[i])[["t111"]][7,],
          get(data.names[i])[["t112"]][7,], get(data.names[i])[["t120"]][7,],
          get(data.names[i])[["t121"]][7,], get(data.names[i])[["t122"]][7,]),
        time.8 = c(rep(get(data.names[i])[["tbas"]][8], niter),
          ...
          get(data.names[i])[["t022"]][8,], get(data.names[i])[["t100"]][8,],
          get(data.names[i])[["t101"]][8,], get(data.names[i])[["t102"]][8,],
          get(data.names[i])[["t110"]][8,], get(data.names[i])[["t111"]][8,],
          get(data.names[i])[["t112"]][8,], get(data.names[i])[["t120"]][8,],
          get(data.names[i])[["t121"]][8,], get(data.names[i])[["t122"]][8,]),
        time.9 = c(rep(get(data.names[i])[["tbas"]][9], niter),
          ...
          get(data.names[i])[["t022"]][9,], get(data.names[i])[["t100"]][9,],
          get(data.names[i])[["t101"]][9,], get(data.names[i])[["t102"]][9,],
          get(data.names[i])[["t110"]][9,], get(data.names[i])[["t111"]][9,],
          get(data.names[i])[["t112"]][9,], get(data.names[i])[["t120"]][9,],
          get(data.names[i])[["t121"]][9,], get(data.names[i])[["t122"]][9,]),
        tse = fit.par.tse
      )
...
# True vs. Pred
  ...
  levels(plotdata2$typef) <- c("otter", "otter+glam", "otter+olam",
    ...
    "otter+tmax+halft+glam", "otter+tmax+halft+olam", "basic")
  ...
  plotdata2 <- plotdata[plotdata$type %in% c("000", "100", "bas"), ]
  plotdata2$typef <- factor(plotdata2$type)
  levels(plotdata2$typef) <- c("otter", "otter+tmax", "basic")
  statdata <- ddply(plotdata2, .(data, metric, typef), function(x) {
    data.frame(
      percbioq = paste0("bioq = ", signif(sum(x$bioq, na.rm = T)/length(x$bioq)*100, 3), "%"),
      meanratio = paste("mean =", round(mean(x$prop), 2))
...
# Box plot
  ...
  levels(subdata$typef) <- c("otter", "otter+geolamz", "otter+optlamz",
    "otter+auctlast", "otter+auctlast+geolamz", "otter+auctlast+optlamz",
    "otter+halftlast", "otter+halftlast+geolamz", "otter+halftlast+optlamz",
    "otter+tmax", "otter+tmax+geolamz", "otter+tmax+optlamz",
    "otter+tmax+auctlast", "otter+tmax+auctlast+geolamz", "otter+tmax+auctlast+optlamz",
    "otter+tmax+halftlast", "otter+tmax+halftlast+geolamz", "otter+tmax+halftlast+optlamz", "basic")
  ...
  s1 <- NULL
  s1 <- ggplot(plotauc24[plotauc24$typef %in% c("otter", "otter+tmax", "basic"), ], aes(x = typef, y = prop))
  ...
  s2 <- ggplot(plotauctlast[plotauctlast$typef %in% c("otter", "otter+tmax", "basic"), ], aes(x = typef, y = prop))
  ...
  s3 <- ggplot(plotaucinf[plotaucinf$typef %in% c("otter", "otter+tmax", "basic"), ], aes(x = typef, y = prop))
  ...
  s4 <- ggplot(plotcmax[plotcmax$typef %in% c("otter", "otter+tmax", "basic"), ], aes(x = typef, y = prop))
  ...
  s5 <- ggplot(plottmax[plottmax$typef %in% c("otter", "otter+tmax", "basic"), ], aes(x = typef, y = prop))
